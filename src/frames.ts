...
export const flipFrames = frameArray => frameArray.map(flipFrame);

export const descriptiveToFrame = (obj) => {
    return {
        r: [
...
export const staticColorFrame = (rgb) => {
    let frame = {};
